<link rel="stylesheet" type="text/css" href="css/signin_act.css" />
...
if (!$val) {
  ...
  echo "<div class='error-msg'>401 - 認証エラー -</div>";
  echo "<div class='lead-dd'>認証に失敗しました。<br>認証のためのユーザ名またはパスワードをご確認の上再度入力してください。</div>";
  echo "<div class='totop-btn'><a href=signin.php>トップページへ</a></div>";
  exit();
} else {
  $_SESSION = array();
